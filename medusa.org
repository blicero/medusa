...
# Time-stamp: <2025-05-17 22:56:00 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2025-05-17 Sa 22:55]
   | Headline                              | Time      |           |          |       |      |
   |---------------------------------------+-----------+-----------+----------+-------+------|
   | *Total time*                          | *2d 3:49* |           |          |       |      |
   |---------------------------------------+-----------+-----------+----------+-------+------|
   | *Medusa [8/11]*                       | *2d 3:49* |           |          |       |      |
   | \_  /Features [0/1]/                  |           | /1:09/    |          |       |      |
   | \_    Intermittent connectivity [0/0] |           |           |     1:09 |       |      |
   | \_  /Components [7/10]/               |           | /2d 1:48/ |          |       |      |
   | \_    Main [0/0]                      |           |           |     0:40 |       |      |
   | \_    Probes [1/3]                    |           |           |    10:20 |       |      |
   ...
   | \_      Pool                          |           |           |          |  0:28 |      |
   | \_    Server [4/5]                    |           |           | 1d 10:46 |       |      |
   | \_      Web Interface [0/1]           |           |           |          | 10:49 |      |
   | \_        Graphs                      |           |           |          |       | 3:05 |
...
** Features [0/1]
   ...
   :VISIBILITY: children
   :END:
*** TODO Intermittent connectivity [0/0]
    :LOGBOOK:
