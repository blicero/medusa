...
# Time-stamp: <2025-05-07 18:16:29 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2025-05-07 Mi 18:16]
   | Headline                     | Time       |            |         |       |      |
   |------------------------------+------------+------------+---------+-------+------|
   | *Total time*                 | *1d 14:34* |            |         |       |      |
   |------------------------------+------------+------------+---------+-------+------|
   | *Medusa [5/7]*               | *1d 14:34* |            |         |       |      |
   | \_  /Components [5/7]/       |            | /1d 14:34/ |         |       |      |
   | \_    Probes [0/0]           |            |            |    2:31 |       |      |
   | \_    Model [0/0]            |            |            |    2:17 |       |      |
   | \_    Database [2/2]         |            |            |    1:45 |       |      |
   | \_      Exception handling   |            |            |         |  0:09 |      |
   | \_      Pool                 |            |            |         |  0:28 |      |
   | \_    Server [3/5]           |            |            | 1d 8:01 |       |      |
   | \_      Web Interface [0/1]  |            |            |         |  8:37 |      |
   | \_        Graphs             |            |            |         |       | 0:53 |
